...
| T01 | READY | Bootstrap Rust workspace in `RustSynth/` | T00 | Cargo workspace, crate skeletons, base lint/test config |
| T02 | READY | Build legacy feature matrix and parity checklist | T00 | feature inventory mapped to legacy modules/examples |
| T03 | READY | Collect golden fixtures from legacy examples | T00 | curated example set, fixture manifest, expected outputs notes |
| T04 | BLOCKED | Implement preprocessor crate | T01, T02, T03 | Rust preprocessor with tests for `#define`, random substitution, GUI parameter metadata |
| T05 | BLOCKED | Implement lexer/tokenizer crate | T01, T02, T03 | token stream and diagnostics tests |
